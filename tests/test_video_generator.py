...
from video_gen.video_generator import (
    _get_stitch_config,
    _validate_stitch_model,
    _build_expected_out_paths,
...
class TestStitchConfigLoading(unittest.TestCase):
    ...
    def test_veo3_provider_loads_veo3_config(self, mock_from_env):
        ...
        result = _get_stitch_config("veo3", None)
    ...
    def test_runway_provider_loads_runway_config(self, mock_from_env):
        ...
        result = _get_stitch_config("runway", None)
    ...
    def test_returns_provided_config_when_not_none(self):
        ...
        result = _get_stitch_config("veo3", mock_config)
...
class TestStitchModelValidation(unittest.TestCase):
    ...
    def test_valid_veo3_model_passes(self):
        ...
        try:
            _validate_stitch_model("veo3")
            _validate_stitch_model("veo3.1")
            _validate_stitch_model("veo3.1_fast")
        except ValueError:
    ...
    def test_valid_google_veo_model_passes(self):
        ...
        try:
            _validate_stitch_model("veo-3.1-generate-preview")
            _validate_stitch_model("veo-3.1-fast-generate-preview")
            _validate_stitch_model("veo-3.0-generate-001")
        except ValueError:
            self.fail("_validate_stitch_model raised ValueError for valid veo model")
...
class TestBuildExpectedOutPaths(unittest.TestCase):
    """Test _build_expected_out_paths helper function."""
    ...
    def test_with_custom_out_paths(self):
        ...
        result = _build_expected_out_paths(3, custom_paths, "veo3")
...
class TestComputeResumeState(unittest.TestCase):
    """Test _compute_resume_state helper function."""
    ...
    def test_no_existing_clips(self):
        ...
        outputs, start_idx, last_frame = _compute_resume_state(expected_paths)
    ...
    def test_all_clips_completed(self):
        ...
        with patch('video_gen.video_generator.extract_last_frame_as_png') as mock_extract:
